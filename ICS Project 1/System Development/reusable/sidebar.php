    ...
    <body>
        ...
        <script>
            ...
            dropdown.addEventListener('click', function (event) {
                ...
                dropdownContent.style.top = rect.top + 'px';  // Aligning the dropdown with the top of the gear icon
                dropdownContent.style.left = rect.right + 'px';  // Positioning dropdown next to the gear icon
            });
