<?php
    ...
    if (isset($_POST['add'])){
        header("Location: addExpenditure.php");
    }
            ...
            <div class="row">
                        ...
                        <section style="background: white; border-radius: 50px;" class="mt-3">
                            <div class="d-flex justify-content-center">
                                <form class="px-3 py-5" id="expenditure" method="POST">
                                    <h3>Expenditure</h3>
                                    <p class="mt-3" style="color: grey;">Add Your Expenditure and Payment Records Below</p>

                                    <img src="../Images/transactionImg.png" width="450px" height="200px"><br>
                                        
                                    <input class="btn text-white px-2 form-control mt-4" type="submit" id="add" name="add" value="Add Record" style="background-color: #8282AB; border-radius: 20px;" onclick="window.location.href='addExpenditure.php'">                       
                                </form>
                            </div>
                        </section>
                    </div>
                ...
                <div class="col-4 my-2 py-2 mx-2 px-3" style="background-color: white; border-radius: 25px;">
                    ...
                    <div>
                        ...
                        ?>
                        <input class="btn text-white px-2 mb-2 mt-4 form-control" type="submit" id="view" name="view" value="View Expenditure" style="background-color: #8282AB; border-radius: 20px;" onclick="window.location.href='viewExpenditure.php'"> 
                    </div>
                </div>
            </div>
        </div>
